...
public class DNAInvalidException extends BaseException {
  private static final long serialVersionUID = 3325180189474835276L;

  public DNAInvalidException(Throwable cause, String message, String exceptionCode, String location, String moreInfo) {
